...
class FollowController {
    constructor() {
         ...
         * database
          */
        this.userFollowsUser = (req, res) => FollowController.followDao.userFollowsUser(req.params.follower, req.params.followed)
        ...
        */
        this.userUnfollowsUser = (req, res) => FollowController.followDao.userUnfollowsUser(req.params.follower, req.params.followed)
        ...
        /**
          ...
          */
        this.findWhoIsFollowingMe = (req, res) => FollowController.followDao.findWhoIsFollowingMe(req.params.followed)
        ...
        /**
          ...
          * body formatted as JSON arrays containing the user objects
          */
        this.findWhoIamFollowing = (req, res) => FollowController.followDao.findWhoIamFollowing(req.params.follower)
            .then(who => res.json(who));
    }
}
