...
export default class BookmarkDao {
    constructor() {
        ...
        this.userBookmarksTuit = (uid, tid) => __awaiter(this, void 0, void 0, function* () { return BookmarkModel.create({ tuit: tid, bookmarkedBy: uid }); });
        this.userUnbookmarksTuit = (uid, tid) => __awaiter(this, void 0, void 0, function* () { return BookmarkModel.deleteOne({ tuit: tid, bookmarkedBy: uid }); });
    }
}
