...
export default class MessageController implements MessageControllerI {
    ...
    userDeletesMessage = (req: Request, res: Response) =>
        MessageController.messageDao.userDeletesMessage(req.params.from, req.params.to)
    ...
    findSentMessages = (req: Request, res: Response) =>
        MessageController.messageDao.findSentMessages(req.params.from)
    ...
    MessageController.messageDao.findReceivedMessages(req.params.to)
        .then(messages => res.json(messages));
 };